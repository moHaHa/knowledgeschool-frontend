...
export default {
  ...
  mutations: {
    ...
    //single record
    setSingleRecordInfo_existedRecordJSONPath (state, existedRecordJSONPath) {
      state.singleRecordInfo.existedRecordJSONPath = existedRecordJSONPath
    },
  ...
  actions: {
    ...
    async fetchAPIRecords ({ state, commit }) {
      ...
      try {
        ...
        commit('setRecords', get(response, state.APIInfo.recordsJSONPath))
